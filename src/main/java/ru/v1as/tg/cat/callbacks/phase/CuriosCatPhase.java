...
public class CuriosCatPhase extends AbstractPhase {
    ...
    private void sayCat(UserData user) {
        saveCatRequest(user);
        sendMessage("Любопытный кот убежал к " + user.getUsernameOrFullName());
        close();
    }

    private void goToCat(UserData user) {
    ...
    private void fastFollowCat(UserData user) {
        sendMessage(
                user,
    ...
    private void followTheCat(UserData user) {
        privatePoll(
                        user,
    ...
    private void resStone(UserData user) {
        sendMessage(
                user,
    ...
    private void catchCat(UserData user) {
        sendMessage(
    ...
    private void saveCatRequest(UserData user) {
